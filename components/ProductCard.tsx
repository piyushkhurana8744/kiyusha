  ...
  return (
    ...
    >
      <Link href={productLink} className="relative block overflow-hidden bg-warmWhite">
        ...
        <button
          type="button"
          className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-warmWhite/95 text-deepCharcoal transition hover:text-softGold"
