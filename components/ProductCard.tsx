      ...
      <div className="space-y-1.5 px-1 pb-2 pt-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              onClick={handleShare}
              className={`flex items-center justify-center p-1.5 rounded-full transition-colors duration-300 ${
                showCopied ? "bg-softGold text-white" : "bg-nudeAccent/20 text-softGold hover:bg-softGold hover:text-white"
              }`}
              title={showCopied ? "Link Copied!" : "Share Product"}
            >
              {showCopied ? (
                <Check size={16} />
              ) : (
